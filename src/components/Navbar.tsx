    ...
    <>
      <motion.nav
        className={`sticky top-0 z-50 w-full transition-all duration-300 ${
          scrolled || hasSeenHero ? "bg-background border-b border-border shadow-sm" : "bg-transparent"
        }`}
        initial={{ y: -80 }}
        animate={{ y: 0 }}
      ...
      >
        {!hasSeenHero ? (
          ...
          {/* Left side: Logo */}
          <Link to="/" className="font-headline text-2xl font-bold tracking-tight text-foreground select-none shrink-0 w-auto hover:text-gold transition-colors">
            Callit
          </Link>
          ...
          <div className="hidden md:flex items-center justify-start flex-1 max-w-[320px]">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full rounded-full border border-border bg-secondary/30 pl-11 pr-4 py-2 text-[14px] font-body text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-gold/50 focus:ring-0 transition-all"
              />
            </div>
          </div>

          {/* Center-Right: Inline Ticker */}
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto py-6 px-4">
                ...
                <div className="px-4 pb-2 pt-4 border-t border-border mt-6">
